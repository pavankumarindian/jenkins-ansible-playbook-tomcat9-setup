pipeline {
    ...
    stages {
        ...
        stage('Run Ansible Playbook') {
            steps {
                ansiblePlaybook credentialsId: 'jenkins-ansible', disableHostKeyChecking: true, installation: 'Ansible', inventory: '/etc/ansible/hosts', playbook: '/etc/ansible/install_tomcat9.yml', vaultTmpPath: ''
            }
        }
    }
